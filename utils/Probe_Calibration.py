...
class ProbeCalibration:
     ...
     def calibrate():
         ...
         new_slope_factor = -model.coef_[0][0]/(np.log(10)*8.3144621*TempK/96485.33212) #59.16 mV is the "Ideal Slope Factor" measuring Nernstian response, = ln(10)RT/F
         new_date = date.today()
         system = pd.read_csv(Path(os.getcwd()+"/utils/System_Info.csv"))
         ...
         print("New Eo: "+str(round(new_Eo*100,3))+"mV  -  New Slope Factor: "+str(round(new_slope_factor, 2)))
